...
public class AboutPanel extends AccuBasePanel {
	...
	public void onStart() {
		...
		String versionString = "1.3.8 (master-api_update)";
		String dateString = "22-01-2018";
		version.setText("Version: " + versionString + "\n" + "Date: "
				+ dateString + "\n" + "IMC version: "
				+ IMCDefinition.getInstance().getVersion());
		authors.setText("Author: José Quadrado Correia");
		contributors
				.setText("Contributors: José Pinto, Hugo Queirós, Paulo Dias, José Loureiro, Mauro Brandão, Pedro Gonçalves");
