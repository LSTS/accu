...
public class EntityStateList extends ListView implements IMCSubscriber,
		MainSysChangeListener {
	public static final String[] SUBSCRIBED_MSGS = { "EntityList",
			"EntityState" };
	...
	public void onReceive(IMCMessage msg) {
		...
		if (Accu.getInstance().getActiveSys() == null)
			return;
		if (Accu.getInstance().getActiveSys().getId() != (Integer) msg
				.getHeaderValue("src"))
			return;
